...
public class LibraryService
{
    ...
    /// <summary>
    /// GET /api/stats. Guarded by optional_get_current_user with an
    /// X-API-Key fallback (routers/library/core.py:105-113), not
    /// get_current_user — so it names no permissionHint. total_size_mb is
    /// books only; library_size_mb covers every collection
    /// (routers/library/_schemas.py:77-79).
    /// </summary>
