...
/// so it names no hints. Create is require_admin with no id to look up, so it
/// names only a permissionHint; delete is require_admin and carries the id,
/// naming a notFoundHint too.
/// </summary>
