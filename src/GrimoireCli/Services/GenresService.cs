...
/// so it names no hints. Create and delete are require_admin; create carries no
/// id but still names a notFoundHint, for an unknown --parent-id, and delete
/// carries the id and names one for that.
/// </summary>
